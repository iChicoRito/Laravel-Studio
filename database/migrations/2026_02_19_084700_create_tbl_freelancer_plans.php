...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbl_freelancer_plans', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('freelancer_id')->comment('FK to tbl_users.id (freelancer)');
            ...
            $table->json('usage_metrics')->nullable()->comment('Current usage metrics (bookings)');
    ...
    {
        Schema::dropIfExists('tbl_freelancer_plans');
    }
};